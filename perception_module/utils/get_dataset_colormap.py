...
def create_cityscapes_label_colormap_rl():
  """Creates a label colormap used in CITYSCAPES segmentation benchmark.
  ...
  colormap[8] = [70, 70, 70]
  colormap[9] = [70, 70, 70]
  colormap[10] = [70, 70, 70]
  colormap[11] = [70, 70, 70] #people
  colormap[12] = [70, 70, 70]
  colormap[13] = [70, 70, 70]
  colormap[14] = [70, 70, 70]
  colormap[15] = [70, 70, 70]
  colormap[16] = [70, 70, 70]
  colormap[17] = [70, 70, 70]
  colormap[18] = [70, 70, 70]
  return colormap
...
def create_label_colormap(dataset=_CITYSCAPES):
...
def create_label_colormap_rl(dataset=_CITYSCAPES):
  """Creates a label colormap for the specified dataset.
  ...
  if dataset == _ADE20K:
    ...
    return create_cityscapes_label_colormap_rl()
  elif dataset == _MAPILLARY_VISTAS:
    return create_mapillary_vistas_label_colormap()
  elif dataset == _PASCAL:
    return create_pascal_label_colormap()
...
def label_to_color_image_rl(label, dataset=_CITYSCAPES):
  """Adds color defined by the dataset colormap to the label.
  ...
  colormap = create_label_colormap_rl(dataset)
  return colormap[label]
